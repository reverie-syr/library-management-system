...
@Getter
@Setter
public class ListAuteursDialog extends JDialog {
    ...
    // JLabels
    private final JLabel titleLabel = new JLabel("Liste Des Auteurs");
    // ImageIcons
    ...
    public ListAuteursDialog(JPanel parentPanel){
        super(adminParentFrame, "Liste Des Auteurs", true);
        ...
        table.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (e.getClickCount() == 1) {
                    ...
                    auteur = librairie.getAuteur(id);

                    if (parentPanel instanceof AjouterLivre){
                        final AjouterLivre parentPanel = AjouterLivre.getInstance();
                        parentPanel.getAuteurTextField().setText(auteur.toString());
                    }
                    if (parentPanel instanceof ModifierLivre){

                        final ModifierLivre parentPanel = ModifierLivre.getInstance();
                        parentPanel.getAuteurTextField().setText(auteur.toString());

                    }

                    ListAuteursDialog.this.dispose();
                }
            }
        });
