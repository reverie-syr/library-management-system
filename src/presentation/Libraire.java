...
public class Libraire extends JFrame {
    //
    private static JFrame libraire;
    ...
    private static  JPanel LibraireCardPanel = new JPanel(cardlayout);
    ...
    private Libraire() {
        ...
        // background colors
        booksTitlePanel.setBackground(new Color(106,90,205).darker());
        booksPanel.setBackground(new Color(106,90,205));
        //
        membersTitlePanel.setBackground(new Color(220,20,60).darker());
        membersPanel.setBackground(new Color(220,20,60));
        //
        authorsTitlePanel.setBackground(new Color(128, 0, 128).darker());
        authorsPanel.setBackground(new Color(128, 0, 128));

        // Books Section
        latestBooksLabel.setFont(new Font("Arial",Font.BOLD,24));
        latestBooksLabel.setForeground(Color.WHITE);
        latestBooksAddedPanel.setBackground(new Color(65,105,225));

        booksSection.setBorder(BorderFactory.createMatteBorder(10,10,10,10, new Color(65,105,225).darker()));
        bookImagesPanel.setBackground(new Color(65,105,225).darker());
        ...
        LibraireCardPanel.setLayout(cardlayout);
        LibraireCardPanel.add(rightPanel, "Home Panel");

        // Action Listeners:
        libraryButtonIcon.addActionListener(e -> cardlayout.show(LibraireCardPanel, "Home Panel"));

        GererUtilisateur gererUtilisateur = new GererUtilisateur();
        LibraireCardPanel.add(gererUtilisateur, "Gérér Utilisateur");
        JButton backButton = gererUtilisateur.getRetour();

        backButton.addActionListener(e -> cardlayout.previous(LibraireCardPanel));
        AjouterMembre ajouterMembre = new AjouterMembre();
        LibraireCardPanel.add(ajouterMembre, "Ajouter Membre");
        ajouterMembreButton.addActionListener(e -> cardlayout.show(LibraireCardPanel,"Ajouter Membre"));

        ModifierMembre modifierMembre = new ModifierMembre();
        LibraireCardPanel.add(modifierMembre, "Modifier Membre");
        modifierMembreButton.addActionListener(e -> cardlayout.show(LibraireCardPanel, "Modifier Membre"));

        ListeMembre listeMembre = new ListeMembre();
        LibraireCardPanel.add(listeMembre, "Liste Membre");
        listMembreButton.addActionListener(e -> cardlayout.show(LibraireCardPanel, "Liste Membre"));


        GererAuteurs gererAuteurs = new GererAuteurs();
        LibraireCardPanel.add(gererAuteurs, "Gérer Auteurs");
        gererAuteursButton.addActionListener(e -> cardlayout.show(LibraireCardPanel, "Gérer Auteurs"));

        GererGenres gererGenres = new GererGenres();
        LibraireCardPanel.add(gererGenres, "Gérer Genres");
        gererGenresButton.addActionListener(e -> cardlayout.show(LibraireCardPanel, "Gérer Genres"));

        LibraireCardPanel.add(ajouterLivre, "Ajouter Livre");
        ajouterLivreButton.addActionListener(e -> cardlayout.show(LibraireCardPanel, "Ajouter Livre"));

        LibraireCardPanel.add(modifierLivre, "Modifier Livre");
        modifierLivreButton.addActionListener(e -> cardlayout.show(LibraireCardPanel, "Modifier Livre"));

        ListeLivre listLivre = new ListeLivre();
        LibraireCardPanel.add(listLivre, "Liste Livre");
        listLivreButton.addActionListener(e -> cardlayout.show(LibraireCardPanel, "Liste Livre"));

        LibraireCardPanel.add(attribuerLivre, "Attribuer Livre");
        issueBookButton.addActionListener(e -> cardlayout.show(LibraireCardPanel, "Attribuer Livre"));

        RetournerLivre retournerLivre = new RetournerLivre();
        LibraireCardPanel.add(retournerLivre, "Retourner Livre");
        returnBookButton.addActionListener(e -> cardlayout.show(LibraireCardPanel, "Retourner Livre"));


        this.add(menuBar, BorderLayout.WEST);
        this.add(LibraireCardPanel, BorderLayout.CENTER);
